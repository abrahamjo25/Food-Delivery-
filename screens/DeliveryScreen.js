...
export default function DeliveryScreen() {
  ...
  return (
    <View className="flex-1">
      <View className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"></View>
      ...
      <View className="rounded-t-3xl -mt-12 bg-white relative">
        ...
        >
          ...
          <View className="flex-1 ml-3">
            <Text className="text-lg font-bold text-white">Abraham J</Text>
